...
Sample data represented as .xlsx files were extracted from .kinarm files using the analysis scripts. Due to the large size of the .kinarm files, they were not uploaded onto github. Please email: apark2@uottawa.ca to request data.
