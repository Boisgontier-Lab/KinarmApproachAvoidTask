function data_out = KINARM_add_hand_kinematics_Kayne(data_in)
...
%Kinarm tasks with lower sampling rate have greater quantization noise so
%this script was modified to calculate the L1/L2 acceleration based on the
%differential of L1/L2 velocity rather than calculating it from the L1/L2
%acceleration
